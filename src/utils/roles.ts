...
export const getRoleTokens = (role: AuthRole): { tokenKey: string; loginKey: string; idKey: string } => {
  ...
  switch (normalizedRole) {
    case ROLES.MEDICINE:
      return { tokenKey: "tokenMedicine", loginKey: "LoginMedicine", idKey: "id_medicine" }
