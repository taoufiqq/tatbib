      ...
      <section className="header-page">
          <div className="container">
           ...
           <div className="card EspaceMedicine">
             ...
             <div  className="EspaceProfessionnel">Access the Professionals spaces</div>
             <div className="btn">
             <Link href="/login_medicine" style={{textDecoration:"none",lineHeight:2,color:"white"}} type="submit" className="EspaceProfessionnelButton1">Medicine</Link>
             <Link href="/login_secretary" style={{textDecoration:"none",lineHeight:2,color:"white"}} type="submit" className="EspaceProfessionnelButton1">Secretary</Link>
             </div>
           </div>
