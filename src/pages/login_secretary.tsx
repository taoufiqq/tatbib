    ...
    axios.post(`https://tatbib-api.onrender.com/secretary/login`,Secretary)
        ...
        if(!res.data.message){ 
            ...
            if(status === "InActive"){
                ...
                toast.info('You cant use this Account now, Please wait for it to be activated!!!', {
                    position: "top-right",
                    autoClose: 5000,
             ...
             console.log("You can't use this Account now, Please wait for it to be activated!!!")
