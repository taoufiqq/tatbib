      ...
      <nav className="menu noPrint" tabIndex={0}>
        ...
        <ul>
          <li tabIndex={0} className="icon-customers">
            <MdDashboard />
            <Link href="/patient_dashboard" style={{ textDecoration: "none", color: "white" }}>
          ...
          <li tabIndex={0} className="icon-profil">
            <FaUserEdit />
            <Link href="/account_patient" style={{ textDecoration: "none", color: "white" }}>
              <span>MyAccount</span>
            </Link>
          </li>
      ...
      <main>
        ...
        <div className="table-responsive">
          <div className="table-wrapper">
            ...
            {!loading && !error && currentItems.map((item: any, index: number) => (
              <div id={`ordonnance-${index}`} className="blog-slider mt-5" key={index}>
