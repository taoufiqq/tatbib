  ...
  return (
        ...
        <section className="header-page">
          ...
          <div>
           ...
           <label className="form-label" style={{marginTop:'1%'}}>Sign Up</label>
            ...
            <div className="row ">
             ...
             <div>
                 ...
                 <Link href="/login_patient" style={{textDecoration:"none"}}><input type="submit"  className="form-control mt-3 btnAuth"  value="I already have an account"/></Link>
