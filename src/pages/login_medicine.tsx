...
export default function LoginMedcine() {
    ...
    axios.post(`https://tatbib-api.onrender.com/medcine/login`,medcine)
        ...
        if(!res.data.message){ 
            ...
            //  console.log(res.data)
        if(verifier === false){
             console.log('Please Verifier You Accout First by Click on URL In Your Email Box')
        }else{
          ...
          <div className="col-12 col-md-12 col-lg-6 " style={{marginTop:'4%'}}>
           ...
           <label className="form-label">Login as a Doctor</label>
             <div className="fromlogin">
                 ...
                 <input  type="text" placeholder="Login" className="form-control"  required  
                 value={login} 
                ...
                <button type="submit"  className="form-control mt-5 btnConnect">
                  log in
                 <ToastContainer />
                 </button>
                 <Link href="/sign_up_medicine" style={{textDecoration:"none"}}><input type="submit"  className="form-control mt-3 btnAuth"  value="Create an account"/></Link>
         
             </div>
           </form>
           </div>
           <div className="col-12 col-md-12 col-lg-6 ">
              <Image alt="" src={Imglogin} style={{width:"70%",marginLeft:"60px"}} className="imgLogin"/>
           </div>
           </div>
           </div>
         </div>
