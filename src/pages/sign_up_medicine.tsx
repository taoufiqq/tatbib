...
axios.post(`https://tatbib-api.onrender.com/medcine/authentication`,medicine)
    .then(res => {
    
        if(!res.data.message){
            router.push('/login_medicine')
            toast.success('authenticated SuccessFully', { position: "top-left",
            autoClose: 5000,
            ...
            toast.warn('authenticated Failed!!!!!', { position: "top-left",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: false,
            pauseOnHover: false,
          ...
          <div>
           ...
           <label className="form-label">Sign Up</label>
             ...
             <label htmlFor="fullName"></label>
                 <input type="text" placeholder="FullName" className="form-control" name="fullName" id="fullName" required    
                 />
             </div>
            <div className="col-md-6">
            <label htmlFor="speciality"></label>
                 <input  type="text" placeholder="Speciality" className="form-control" id="speciality" name="speciality" required  
           />
            </div>
            </div>
            <div className="row ">
            ...
            <label htmlFor="city"></label>
                 <input  type="text" placeholder="City" className="form-control" id="city" name="city"  required  
                 />
             </div>
             <div className="col-md-6">
             <label htmlFor="email"></label>
                 <input  type="text" placeholder="Email" className="form-control" id="email" name="email"  required 
                />
            </div>
            </div>
            <div className="row ">
             ...
             <div>
                 ...
                 <Link href="/login_medicine" style={{textDecoration:"none"}}><input type="submit"  className="form-control mt-3 btnAuth"  value="I already have an account"/></Link>
