...
const logOut =()=>{
  ...
  <nav className="menu" tabIndex={0}>
    ...
    <ul>
      ...
      <li tabIndex={0} className="icon-users"><Link href='/ordonnances_by_patient' style={{textDecoration:"none",color:"white"}}><span>Ordonnances</span></Link></li>
  ...
  <div className="table-title">
    ...
    <Link href="/search_medicine" style={{textDecoration:"none"}}><input type="button"  className="form-control mt-5 btnConnect rendez-vous" id="Rdv" value="Make an appointment"/></Link>
  </main>
</div>
     );
}
