...
export default function LoginPatient() {
    ...
    return (
        ...
        <section className="header-page">
          ...
          <div className="row">
          <div className="col-12 col-md-12 col-lg-6 "  style={{marginTop:'2%'}}>
           ...
           <label className="form-label">Login</label>
             <div className="fromlogin">
                 ...
                 <Link href="/sign_up_patient" style={{textDecoration:"none"}}><input type="submit"  className="form-control mt-3 btnAuth"  value="Create an account"/></Link>
