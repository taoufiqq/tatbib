        ...
        <div className="cardOrdonnance">
          ...
          <div className="row ">
            <div>
              ...
              >
                <label className="OrdonnanceDate">
                  <span style={{ color: "red" }}>Dr </span>
                  {fullNameDoctor}
                </label>
                <label className="OrdonnanceDate" style={{ color: "green" }}>
                  {speciality}
                </label>
                <div>
                  <label className="OrdonnanceDoctor">
                    <span style={{ color: "red" }}>Mr/Mme </span>
                    {firstNamePatient} {lastNamePatient}
                  </label>
                </div>
                ...
                <div className="fromloginSignUp">
                  <div className="row ">
                    ...
                    <label className="dateOrdonnance">
